...
//                
//                var_dump( rcp_get_membership( $user_id ) );
//                
//                wp_die();
                $new_payment = 1;
...
//                        rcp_transition_membership_status( $old_status_level, 'active', $user_id);
...
//                    echo '<pre style="direction:ltr">';
//                        var_dump( $old_status_level );
//                        var_dump( $member_new_expiration );
//                        wp_die();
